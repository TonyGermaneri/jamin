        ...
        <v-window v-model="state.ui.settingsTab">
          ...
          <v-window-item value="help">
            <div class="jamin-mono text-caption">
              ...
              <p class="mb-2"><strong>Quality.</strong> <code>A- Am Ami Amin Aminor</code> are the same. So are <code>A AM Ama Amaj Amajor</code>. Also <code>dim ° o</code>, <code>ø halfdim</code>, <code>aug +</code>, <code>sus sus2 sus4</code>, <code>alt</code>.</p>
